...
% This script plots rank-order consistency as a function of sample size
% and trial count using simulated data based on Hedge et al.'s (2018) 
% parameters.
%
%% Outputs:
...
save('rankOrderConsistencySIM','rnkCCs','rnkCCk','ICCr')
%load rankOrderConsistencySIM

%% Plot heatmap (Figure 7)
% ICC
figure
