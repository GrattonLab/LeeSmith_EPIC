...
% This script fits the model to Hedge et al.'s (2018) flanker task data 
% across varying noise sigma values to best replicate the ICCs of the 
% empirical data by minimizing the sum of squared errors.
% Noise is added when simulating data for EZ-diffusion modeling and
% analyzing rank-order consistency.
%
%% Outputs:
% - Noise sigma values for reaction time (RT) and accuracy
