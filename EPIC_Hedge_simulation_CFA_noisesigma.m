...
% Fits the model to Hedge et al.'s (2018) flanker and Stroop task data 
% across varying sizes of noise sigma to best replicate the ICCs of the
% empirical data (via minimizing the sum of squared error)
% The noise will be added when simulating data for confirmatory factor
% analysis (CFA) to examine how sampling size affects the reliability of 
% factor analysis
%
% What this script outputs:
% The noise sigma value and the heatmap of the sum of squared error across
...
UpB = 97.5;  % 95% confidence interval upper bound
LwB = 2.5;  % lower bound
