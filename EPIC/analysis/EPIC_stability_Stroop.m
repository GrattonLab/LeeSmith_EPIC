...
% difference betweeen the reference set and the test set sample) for
% reaction time (RT) facilitation effect and interference effect of the
% Stroop task.
...
nTrials = 108/bD;  % this amount is added on each step
nSteps = (nBlocksT*bD)/2;  % number of steps; add half the block to the test set on every step
UpB = 97.5;  % upper percentile of the 95% confidence interval
...
%    'EPIC 07','EPIC 08','EPIC 10','EPIC 12','FontSize',12)
%% Interference effect
figure
for i = 1:nSubj
