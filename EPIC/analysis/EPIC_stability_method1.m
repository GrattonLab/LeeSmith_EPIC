...
% You need mat-files (FL_CEmat.mat, PP_CEmat.mat, and ST_CEmat.mat) for
% Supp. Fig. 11 (see below).
%
...
% Supp. Fig. 11: Percentage to grand mean (requires FL/PP/ST_CEmat.mat)
% Supp. Fig. 12A: CE accuracy
% Supp. Fig. 13A: CE IES
% Supp. Fig. 17: Before and after linear regression of the practice effects
%
...
%% The percentage relative to the grand mean (Supp. Fig. 11)
