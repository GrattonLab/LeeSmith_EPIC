...
% You will need the following dataset and files.
%   - Robinson & Steyvers' (2023) flanker task data (https://osf.io/6hjwv/)
%   - Matlab function file: "ezdiffusion.m" (https://github.com/GrattonLab/LeeSmith_EPIC)
%   - Mat-file: ICC.m (https://www.mathworks.com/matlabcentral/fileexchange/22099-intraclass-correlation-coefficient-icc)
% Note: When running EZ-diffusion model, reaction time must be in seconds.
%
%% Purpose of the script:
% This script applies the EZ-diffusion model to Robinson and Steyvers' 
% (2023) data and evalulates the reliability of model parameters across
...
%% 1. Preprocess data
% (1) Exclude participants - Make sure to have consistent criteria across analyses
...
%% Plot the results: EZD modeling parameters (Figure 8)
cmap1 = parula(3);
cmap2 = spring(3);
cmap3 = cool(3);
